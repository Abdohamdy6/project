        ...
        <div class="distance-result">
            ...
            {% if need_result['required_5th_year_percentage'] < 60 %}
                <div class="motivational-message" style="background: linear-gradient(45deg, #f44336, #ff5722);">
                    ❌ Target requires <span class="highlight-number">{{ need_result['required_5th_year_percentage'] }}%</span> in 5th year, which is below 60%!
            ...
            {% elif need_result['required_5th_year_percentage'] <= 100 and need_result['required_5th_year_percentage'] >= 60 %}
                <div class="motivational-message">
                    🎯 You need to score <span class="highlight-number">{{ need_result['required_5th_year_percentage'] }}%</span> in your 5th year to reach {{ need_result['target_percentage'] }}% total!
            ...
            {% elif need_result['required_5th_year_percentage'] > 100 %}
                <div class="motivational-message" style="background: linear-gradient(45deg, #f44336, #ff5722);">
                    ⚠️ Target requires <span class="highlight-number">{{ need_result['required_5th_year_percentage'] }}%</span> in 5th year, which is above 100%!
